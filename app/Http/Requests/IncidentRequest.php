 ...
 *     @OA\Property(property="city_id", type="integer", example="16"),
 *     @OA\Property(property="township_id", type="integer", example="17"),
 *     @OA\Property(property="country_id", type="integer", example="95"),
